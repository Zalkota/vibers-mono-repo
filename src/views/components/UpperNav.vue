...
<div class="flex-initial tracking-widest" style="font-family: Luckiest Guy;">
      <nav role="navigation" class="w-full p-2 ">
                    <div class="flex flex-row ">

                        <div class="flex-1 px-2  w-full lg:px-4 mt-3  mx-auto ">
                            <svg class="block mx-auto mb-1 pt-1 unhide" width="40" height="40" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="hide" href="https://discord.com/invite/rVXUVBcqJV" target="_blank">
