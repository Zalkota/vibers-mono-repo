                    ...
                    <div class="flex flex-row justify-items-end">
                        ...
                        <div class="hide flex-auto px-2 mt-1 lg:mt-0 text-center">
                            <router-link class="no-underline" to="/whitelist">
                                <div class="bg-two text-2xl color-four font-bold my-2 lg:py-3 lg:px-6 py-2 px-4 rounded cursor-pointer shadow-sm hover:shadow-md rounded-xl max-w-xs no-underline">Join Whitelist</div>
                            </router-link>
                        </div>
                        ...
                        <div v-if="web3Modal.active == true" class="flex-1 px-1 mt-1 lg:mt-0 text-center">
                            <router-link class="no-underline" to="/profile">
                                <div  class="button bg-gray-300  text-md text-black font-bold lg:py-4 py-2 my-2 px-3 lg:px-4 cursor-pointer hover:shadow-sm md:rounded-xl rounded-md border border-gray-400">{{ userAddressSlice() }}</div>
                            </router-link>
                        </div>
                    </div>
