<template>
  <div class="section py-4 text-white h-full bg-gray-100" style=" min-height: 200px;">
    <div class=" h-full ">
      <div class=" flex lg:flex-row h-full">
               <div class='flex-1/4 discord'>
                   <a
                       href='https://discord.com/invite/rVXUVBcqJV'
                       target='_blank'
                       rel='noopener noreferrer'>
                       <FaDiscord />
                   </a>
               </div>
               <div class='flex-1/4 twitter'>
                   <a
                       href='https://twitter.com/CosmicCapsNFT'
                       target='_blank'
                       rel='noopener noreferrer'>
                       <FaTwitter />
                   </a>
                   ...
                   clipboard-id="document_1nf6dmt">
                       <defs></defs><path
               d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm6.066 9.645c.183 4.04-2.83 8.544-8.164 8.544-1.622 0-3.131-.476-4.402-1.291 1.524.18 3.045-.244 4.252-1.189-1.256-.023-2.317-.854-2.684-1.995.451.086.895.061 1.298-.049-1.381-.278-2.335-1.522-2.304-2.853.388.215.83.344 1.301.359-1.279-.855-1.641-2.544-.889-3.835 1.416 1.738 3.533 2.881 5.92 3.001-.419-1.796.944-3.527 2.799-3.527.825 0 1.572.349 2.096.907.654-.128 1.27-.368 1.824-.697-.215.671-.67 1.233-1.263 1.589.581-.07 1.135-.224 1.649-.453-.384.578-.87 1.084-1.433 1.489z"
               stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" fill="#FFFFFF" transform="matrix(1 0 0 1 376.315 556.476)"
               class="" fill-opacity="0.04"/></svg>  */}

               </div>
               <div class='flex-1/4 opensea'>
                   <a
                       href='https://opensea.io/collection/cosmic-caps/'
                       target='_blank'
                       rel='noopener noreferrer'>
                       <svg
                           width='90'
               ...
               <div class='flex-1/4 etherscan'>
                   <a href='https://etherscan.io/address/0xf3c9b7a97eba579f5c234f79108331f5513c9741' target='_blank' rel='noopener noreferrer'>
                       <svg
                           xmlns='http://www.w3.org/2000/svg'
                           width='293.775'
                           height='293.667'
