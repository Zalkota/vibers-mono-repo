<template>
  <div>
    <div class="section bg-gray-200 border-b-4 border-black px-0 lg:px-1">
      <div class="">
        <Navbar v-bind:web3Plug="web3Plug" />
      </div>
    </div>
      ...
      <div class="text-white lg:flex lg:flex-row-reverse">
        ...
        <div class="w-full lg:w-1/2 text-center p-8" v-if="canMint">
          ...
          <div class="my-16 text-center">
            <div class="flex flex-row">
              ...
              <input
                ...
                max="16"
                v-model="mintAmount"
                class="text-black border-black border-2 p-2 mx-4"
              />
              <div
                class="
                  select-none
            ...
            <br />
            <div class="text-white text-xs">0.06 Ξ</div>
          </div>
          ...
          <div>
            ...
            <div class="text-white text-xs my-2">{{ totalSupply }} / 9999</div>
          </div>
        </div>
...
*/
    ...
    async mint() {
      ...
      console.log("calling mint");
      this.totalSupply = await nftContract.methods.mint( userAddress, amt).send({from: userAddress, value:overrides.value, gasLimit:overrides.gasLimit })
