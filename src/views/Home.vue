                      ...
                      <div class="px-6 py-4">
                        ...
                        <div class="w-full">
                            <svg width="100%" height="100%" viewBox="0 0 215 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <path d="M48.0283 7.75005C42.4437 7.75005 42.4437 15.25 48.0283 15.25H87.1211L91.5889 7.75L48.0283 7.75005Z" fill="#F6E05E"/>
                              <path d="M210.543 15.25C216.812 15.25 216.686 7.75005 210.543 7.75005L91.5888 7.75L87.1211 15.25H210.543Z" fill="#E2E8F0"/>
                              <path d="M210.263 44.75C210.263 44.75 49.9829 44.7499 47.749 44.75C42.1644 44.75 42.1644 52.25 47.749 52.25H210.263C216.533 52.25 216.406 44.75 210.263 44.75Z" fill="#F6E05E"/>
                              <path d="M47.749 78.75C42.1644 78.75 42.1644 86.25 47.749 86.25H129.006L132.357 78.75L47.749 78.75Z" fill="#F6E05E"/>
                              <path d="M210.263 86.25C216.533 86.25 216.406 78.75 210.263 78.75L132.357 78.75L129.006 86.25H210.263Z" fill="#E2E8F0"/>
                              <path d="M26.8065 1.75H2.23389V21.75H26.8065V1.75Z" fill="url(#paint0_linear)" stroke="#ABABAB"/>
                              <path d="M29.0403 54.75H0C0 54.75 0 41.75 14.5202 41.75C29.0403 41.75 29.0403 54.75 29.0403 54.75Z" fill="#C4C4C4" stroke="#ABABAB"/>
                              <path d="M3.3855 84.8929C3.08757 81.2978 4.80781 75.75 4.80781 75.75H23.8836C23.8836 75.75 25.9572 81.2708 25.7242 84.8929C25.5474 87.6424 25.7242 89.3069 23.8836 91.75C21.6233 94.75 8.41167 94.75 5.22614 91.75C3.50591 89.4668 3.61311 87.6394 3.3855 84.8929Z" fill="#C4C4C4" stroke="#ABABAB"/>
                              </g>
                              <defs>
                              <linearGradient id="paint0_linear" x1="14.5202" y1="1.75" x2="24.4783" y2="22.8488" gradientUnits="userSpaceOnUse">
