...
module.exports =  class VibeGraph {
    ...
    async deleteDataForContract(contractAddress){
        ...
        await this.mongoInterface.deleteMany('event_datas', {contractAddress: contractAddress})
    ...
    async indexContractData(  contractAddress, contractABI, startBlock, blockGap ){
        ...
        //need better error catch
            ...
            if(!results || results.events.length > SAFE_EVENT_COUNT  ){
                ...
                //save in mongo  
                let existingEventData = await this.mongoInterface.findOne('event_datas', {contractAddress: results.contractAddress, startBlock: results.startBlock })
                if(!existingEventData){
                    ...
                    await this.mongoInterface.insertOne('event_datas',  eventDataToStore    )
